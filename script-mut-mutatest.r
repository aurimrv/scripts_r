...
#Lendo dados
mut<-read.csv("compiled-mutation-score-report-mutatest.csv",sep=";",dec=".",header=TRUE)
mut
summary(mut)

setEPS()
postscript("mutation-score-mutatest-boxplot.eps")
png('mutation-score-mutatest-boxplot.png')
