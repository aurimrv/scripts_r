...
#Lendo dados
mut<-read.csv("compiled-mutation-score-report-mutpy.csv",sep=";",dec=".",header=TRUE)
mut
summary(mut)

setEPS()
postscript("mutation-score-mutpy-boxplot.eps")
png('mutation-score-mutpy-boxplot.png')
