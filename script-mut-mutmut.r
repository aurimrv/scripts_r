...
#Lendo dados
mut<-read.csv("compiled-mutation-score-report-mutmut.csv",sep=";",dec=".",header=TRUE)
mut
summary(mut)

setEPS()
postscript("mutation-score-mutmut-boxplot.eps")
png('mutation-score-mutmut-boxplot.png')
